...
describe('Pair', () => {
  const USDC = new Token(ChainId.MAINNET, '0x6a2d262D56735DbA19Dd70682B39F6bE9a931D98', 18, 'USDC', 'USD Coin')
  const DAI = new Token(ChainId.MAINNET, '0x6De33698e9e9b787e09d3Bd7771ef63557E148bb', 18, 'DAI', 'DAI Stablecoin')

  describe('constructor', () => {
    it('cannot be used for tokens on different chains', () => {
      expect(() => new Pair(new TokenAmount(USDC, '100'), new TokenAmount(WETH[ChainId.SHIDEN], '100'))).toThrow(
        'CHAIN_IDS'
      )
    })
  })
